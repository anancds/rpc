...
namespace ps {
namespace core {
class TestClusterConnectionFailed : public UT::Common {
 public:
  TestClusterConnectionFailed() : scheduler_node_(nullptr), server_node_(nullptr), client_node_(nullptr) {}
  virtual ~TestClusterConnectionFailed() = default;
...
TEST_F(TestClusterConnectionFailed, StartServerAndClientAndStopClient) {
